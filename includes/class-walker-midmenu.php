<?php
class Walker_MidMenu extends Walker_Nav_Menu {
	/**
	 * @see Walker::start_el()
	 * @since 3.0.0
	 *
	...
	function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
		...
		$class_names = ' class="' . esc_attr( $class_names ) . ' item-midmenu"';
		...
		if( $item->menu_order > 2 ) {
			$output .= $indent . '<div class="border-midmenu"></div><li' . $id . $value . $class_names .'>';
		} else {
